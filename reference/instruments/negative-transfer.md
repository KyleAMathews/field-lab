...
name: "Negative-control transfer assay"
summary: "Its prediction and failure boundary on a nearby negative case"
use_when: "A donor mapping may fit everything"
avoid_when: "Do not run without a claimed mapping and a nearby negative case selected before inspecting the desired outcome."
access_target: "Its prediction and failure boundary on a nearby negative case"
requires: "one claimed transfer and a nearby case"
