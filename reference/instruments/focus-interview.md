...
avoid_when: "Skip stable facts, narrow mechanical tasks, explicit one-shot requests, and questions already focused by current context."
...
- **What it requires:** A few focused questions in the current conversation.
