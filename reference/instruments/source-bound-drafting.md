...
requires: "One approved design, frozen source ledger, general writing guide, writer-voice selection, reader goal, and draft research boundary"
...
- **Input:** Approved candidate and design, section-level source trace, frozen source ledger, reader goal and promise, the general writing guide, either no external profile or one selected profile and version, applied writing constraints, known risks and misfits, and an explicit research boundary.
...
1. Freeze the approved design, source ledger, general writing guide, writer-voice selection, applied constraints, reader goal, and research boundary. Give the draft a version identifier. Do not infer, search for, or substitute a personal profile.
...
8. Save the initial draft and a separate pre-edit snapshot. Return both with the applied writing constraints, profile provenance or `none`, source trace, and draft-generated question register. Do not silently revise beyond the bounded transformation.

- **Result:** A versioned source-bound draft, pre-edit snapshot, applied writing constraints, profile provenance or `none`, section and claim trace, generated-example labels, unsupported-addition register, stranded material, and return questions.
