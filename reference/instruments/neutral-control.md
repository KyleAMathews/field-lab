...
summary: "A frozen pre-perturbation baseline and the later delta"
use_when: "A strong probe may add structure that was not present before"
avoid_when: "Do not reconstruct a neutral baseline after exposure unless a fresh context can see only the original specimen."
access_target: "A frozen pre-perturbation baseline and the later delta"
requires: "the same specimen later given to the active instrument"
