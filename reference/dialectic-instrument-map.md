...
Read the workflow, current phase procedure, and named card before starting a scheduled instrument. For replies within an already-started interview, follow `SKILL.md`'s continuation route; setup documents need not be reloaded. At completion or a change of operation, return to the full phase procedure. If their requirements differ, satisfy the stricter requirement. A user waiver may release a named phase deliverable, but it cannot upgrade a downgraded instrument reading or manufacture blindness, independence, support, or confidence.

## Instrument lifecycle

Track every scheduled instrument in the Field Log. Cite existing run/event IDs at phase gates; do not create a second instrument ledger:
...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Entry and throughout | `atlas`                                                                                                                                                       | Gardener or orchestrator keeper assigned; Field Log lineage, instrument records, typed observations, paths, and gaps remain current.                                                                                                                                                                                                               |
...
| Phase 4A             | `fracture-scan`; `residue-collect`; conditional `frame-projector`                                                                                             | One immanent fracture per position; shared assumptions and protected interests preserved as residue; hidden-question projection preserves its typed phenomenology, candidate clusters, tested separators, label workshop, and paired ASCII and interactive HTML diagrams with relevant examples, or records the specific contraindication.                                                                                                             |
