...
| D | `reference/phase4-stage-d-criteria.md` | 4.7, 4.9 | Sublation criteria + HARD STOP + the four-exit refinement-loop router (`reference/phase4.5-refinement-loop.md`) |
